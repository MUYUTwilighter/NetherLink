...
final class NetherLinkTermsScreen extends Screen {
    ...
    protected void init() {
        ...
        if (this.loading) {
            ...
            footer.addChild(Button.builder(CommonComponents.GUI_BACK, ignored1 -> this.onClose()).width(100).build());
            ...
            LinearLayout footer = this.layout.addToFooter(LinearLayout.horizontal().spacing(8));
            Button acceptButton = Button.builder(this.acceptButtonText(), ignored1 -> this.accept()).width(this.shouldEnableFriendNetwork() ? 160 : 100).build();
            acceptButton.active = !this.accepting;
            footer.addChild(acceptButton);
            footer.addChild(Button.builder(Component.translatable("netherlink.terms.decline"), ignored1 -> this.onClose()).width(100).build());
        }
    ...
    private void addBackButton() {
        this.layout.addToFooter(Button.builder(CommonComponents.GUI_BACK, ignored1 -> this.onClose()).width(200).build());
    }
